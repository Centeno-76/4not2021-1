//Função para fins ilustrativos. Se precisar realmente elevar um número ao quadrado, use o operador ** ou a função Math.pow

//Características desta função:
//1) Tem apenas 1 argumentos=
...
function megasena() {
    ...
    //Math.random() -> retorna o número aleatório entre 1 e 0
...
//Conclusão: o formato arrow function é indicado quando a função se resolve em apenas uma linha (ou poucas linhas, como exceção).